<template>
  <div id="Logo">
    <Vue3Lottie
      v-if="theme === ''"
      :animationData="lottie_dark_data"
      :height="100"
      :width="125"
      :loop="true"
    ...
    <Vue3Lottie
      v-else
      :animationData="lottie_white_data"
      :height="100"
      :width="125"
      :loop="true"
      @click="$router.push({ path: '/' })"
  ...
  data() {
    return {
      ...
      lottie_white_data: {
        ...
        w: 432,
        h: 136,
        nm: "ToolsX Logo Animation - Dark Theme",
        ddd: 0,
        assets: [
          {
            id: "image_0",
        ...
        layers: [
            ...
            ks: {
              ...
              r: {
                ...
                k: [
                  ...
                  { t: 23.9999979227274, s: [-45] },
                ],
                ix: 10,
              },
              p: { a: 0, k: [281.742, 86.157, 0], ix: 2 },
              a: { a: 0, k: [43.851, 43.852, 0], ix: 1 },
          ...
          },
          {
            ...
            ks: {
              ...
              p: { a: 0, k: [197.743, 86.157, 0], ix: 2 },
              a: { a: 0, k: [44.993, 44.993, 0], ix: 1 },
              s: { a: 0, k: [100, 100, 100], ix: 6 },
            },
            ao: 0,
            ip: 0,
          ...
          },
          {
            ...
            ks: {
              o: { a: 0, k: 100, ix: 11 },
              r: { a: 0, k: 0, ix: 10 },
              p: { a: 0, k: [297.729, 65.024, 0], ix: 2 },
              a: { a: 0, k: [208.271, 54.039, 0], ix: 1 },
              s: { a: 0, k: [100, 100, 100], ix: 6 },
            },
            ao: 0,
            hasMask: true,
          ...
          },
          {
            ...
            ks: {
              o: { a: 0, k: 100, ix: 11 },
              r: { a: 0, k: 0, ix: 10 },
              p: { a: 0, k: [39.729, 53.485, 0], ix: 2 },
              a: { a: 0, k: [375.771, 54.5, 0], ix: 1 },
